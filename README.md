🇬🇧 English  
Hash Cracker v1.0 — high-performance password hash recovery tool written in Go.  
Supports parallel processing, advanced dictionary attacks (over 2M+ passwords), mutations (up to 35 per word), four algorithms (MD5, SHA-1, SHA-256, SHA-512), and up to 5.6M passwords/sec (SHA-512).  
Only for legal use: recovering your own passwords, security testing with permission, and educational purposes.  
[Full English description](https://github.com/porgnope/hash-cracker/blob/main/README.en.md)
